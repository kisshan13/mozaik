...
/**
 * Application-layer inference runner for Gemini. Mirrors
 * {@link OpenAIInferenceRunner}: it depends on the {@link ModelRuntime}
 * domain port and receives a concrete infrastructure adapter
 * (`GeminiGenerateContent`) through its constructor — the runner never
 * instantiates a provider client itself; wiring happens at the
 ...
 */
export class GeminiInferenceRunner implements InferenceRunner {
